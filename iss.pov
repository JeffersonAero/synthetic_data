...
#declare Test_Spline2 =
  spline {
    natural_spline
   -0.25, <-1.0, 0.0, 0> + <150.5203325,0.034419999999999,-106.7020245>,
    0.00, <-0.0, 0.0, 0> + <150.5203325,0.034419999999999,-106.7020245>,
    0.25, < 1.0, 0.01, 0.1> + <150.5203325,0.034419999999999,-106.7020245>,
    0.35, < 1.7, 0.15, 0.2> + <150.5203325,0.034419999999999,-106.7020245>,
    0.60, < 2.0, 0.65, 1.2> + <150.5203325,0.034419999999999,-106.7020245>,
    0.80, < 1.2, 0.30, 2.0> + <150.5203325,0.034419999999999,-106.7020245>,
    1.00, < 0.8, 0.1, 2.5> + <150.5203325,0.034419999999999,-106.7020245>
    1.25, < 1.0, 0.0, 3.0> + <150.5203325,0.034419999999999,-106.7020245>
  }
//=================================================================================
...
object{ HarnessSegment( 1 ,// Conductors, max. 61// # of wire strands in wire bundle, 
                      0.050, // WireR,  // >0 // radius of wire
                      800, // NrSamples,  // # of samples in spline
                      2, // NrTwist,  // # of 360 degress turns of the bundle 
                      Test_Spline2, // Spline name, 
                      <0, 0, 1 >,// Color, // base color of the wire
                      0.25 , // VaryColor,   // 
                      0, // Start,//  Start point on spline 
                      1) // End,  //  End point on spline                     
       rotate<0,0,0> 
