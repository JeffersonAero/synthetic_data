...
wire = Object(f'HarnessSegment(1, 0.020, 2000, 2, {spline_str}, <1, 0, 0>, 0.25, 0, 1)', 'translate', [150.5, 0, -106.7])
wire_gt = Object(f'HarnessSegment(1, 0.020, 2000, 2, {spline_str}, <1, 0, 0>, 0.25, 0, 1)', 'translate', [150.5, 0, -106.7])
...
# Ground-truth
wire_scene =  Scene(camera, objects=[light,bg_gt,wire_gt], included=["colors.inc",wire_path])
